...
//    var list=videoSection.data!.dataOB.sectionVideosVOList;
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          commonText(courseData.data!.dataOB.courseDetail.subTitle,
          ...
          Row(
            children: [
              ...
              Icon(Icons.all_inbox, color: Colors.orange),
              commonText(
                  "${courseData.data!.dataOB.courseDetail.sectionCount} Section",
                  fontSize: font_16),
              sizedBox(width: 10.0),
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          ListView.builder(
              ...
              shrinkWrap: true,
              itemCount:
                  courseData.data!.dataOB.courseDetail.learningPoints!.length,
  ...
  detailSection(courseData) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      commonText("Course detail",
          fontSize: font_20, fontWeight: FontWeight.bold),
      sizedBox(height: 10.0),
      Text(courseData.dataOB!.courseDetail!.description),
      sizedBox(height: 20.0),
  ...
  Widget freeEnroll() {
    return Row(
      ...
      children: [
        commonText("Free", fontWeight: FontWeight.bold),
        sizedBox(width: 10.0),
        Expanded(
          flex: 2,
          child: TextButton(
            ...
            onPressed: () {toast(message:"ENROLLING");},
            child: commonText('Enroll',color: Colors.white,fontWeight: FontWeight.bold),
          ),
        )
      ],
    );
  ...
  paidEnroll(CourseDataModel courseData) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
        commonText("₹ ${courseData.dataOB!.courseDetail!.price}",
            fontWeight: FontWeight.bold),
        sizedBox(width: 10.0),
        Expanded(
          flex: 2,
